export default {
  ...
  load_test: {
    ...
    check_jmx: "JMX更新，压力配置中线程组将初始化为默认值！",
    thread_num: '并发用户数：',
    ...
    expect_error_rate: '错误率阈值',
    separated_by_commas: '按逗号分隔',
    create: '创建测试',
    run: '一键运行',
    select_resource_pool: '请选择资源池',
    select_resource_pool_slave_num: '压测机数量',
    resource_pool_is_null: '资源池为空',
    resource_pool_size_less_than_slave_num: '压测机数量超过资源池压测机数量',
    ...
    pressure_config_threadnum_invalid_with_slavenum: '线程数不能被压测机数整除!',
    pressure_config_rpslimit_invalid_with_slavenum: 'rps数不能被压测机数整除!',
