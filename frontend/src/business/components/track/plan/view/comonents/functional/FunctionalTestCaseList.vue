      ...
      <template v-slot:header>
        <ms-table-header  :condition.sync="condition" @search="initTableData"
          ...
          <template v-slot:button>
            <ms-table-button  v-if="!showMyTestCase" icon="el-icon-s-custom"
                             :content="$t('test_track.plan_view.my_case')" @click="searchMyTestCase"/>
            <ms-table-button  v-if="showMyTestCase" icon="el-icon-files"
                             :content="$t('test_track.plan_view.all_case')" @click="searchMyTestCase"/>
            <ms-table-button  icon="el-icon-connection"
                             :content="$t('test_track.plan_view.relevance_test_case')"
                             @click="$emit('openTestCaseRelevanceDialog')"/>
            <ms-table-button  icon="el-icon-document-remove"
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template v-slot:default="scope">
            ...
            <ms-table-operator-button  :tip="$t('test_track.plan_view.cancel_relevance')"
