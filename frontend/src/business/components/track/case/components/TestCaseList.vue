    ...
    <el-card class="card-content" v-loading="result.loading">
      <template v-slot:header>
        ...
        <ms-table-header  :condition.sync="condition" @search="initTableData"
          ...
          <template v-slot:button>
            <ms-table-button  icon="el-icon-download"
            ...
            <!--            <ms-table-button  icon="el-icon-right" :content="$t('test_track.case.move')"-->
            <!--                             @click="handleBatch('move')"/>-->
            <!--            <ms-table-button  icon="el-icon-delete" :content="$t('test_track.case.delete')"-->
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template v-slot:default="scope">
            <ms-table-operator  @editClick="handleEdit(scope.row)"
                               @deleteClick="handleDelete(scope.row)">
              <template v-slot:middle>
                <ms-table-operator-button  :tip="$t('commons.copy')"
