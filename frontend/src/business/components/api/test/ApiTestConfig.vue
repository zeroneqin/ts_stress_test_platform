        ...
        <el-container class="test-container" v-loading="result.loading">
          <el-header>
            <el-row>
              ...
              <el-input :disabled="isReadOnly" class="test-gitlab" v-model="test.gitlab" maxlength="100"
                        :placeholder="$t('api_test.gitlab')"
                        show-word-limit>
                <template slot="prepend">Git地址</template>
              </el-input>
              <el-input :disabled="isReadOnly" class="test-gitbranch" v-model="test.gitbranch" maxlength="20"
                        :placeholder="$t('api_test.gitbranch')"
                        show-word-limit>
                <template slot="prepend">Git分支</template>
              </el-input>
