      ...
      <el-col :span="14">
        <el-menu class="header-menu" :unique-opened="true" mode="horizontal" router :default-active='$route.path'>
          ...
          <el-submenu v-show="$store.state.switch.value=='old'"
                      v-permission="['admin','org_member','org_admin','test_manager','test_user','test_viewer']" index="4">
            ...
            <ms-create-button v-permission="['admin','org_member','org_admin','test_manager','test_user']" :index="'/api/test/create'"
                              :title="$t('load_test.create')"/>
          </el-submenu>

          <el-submenu v-show="$store.state.switch.value=='old'"
                      v-permission="['admin','org_member','org_admin','test_manager','test_user','test_viewer']" index="5">
          ...
          <el-menu-item v-show="$store.state.switch.value=='old'"
                        v-permission="['admin','org_member','org_admin','test_manager','test_user','test_viewer']" :index="'/api/monitor/view'">
            {{ $t('commons.monitor') }}
          </el-menu-item>
        </el-menu>
      </el-col>
