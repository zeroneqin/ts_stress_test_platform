...
import io.zeroneqin.api.parse.old.ApiImportParser;
import io.zeroneqin.api.parse.old.ApiImportParserFactory;
import io.zeroneqin.api.parse.old.JmeterDocumentParser;
import io.zeroneqin.base.domain.*;
import io.zeroneqin.base.mapper.ApiTestFileMapper;
import io.zeroneqin.base.mapper.ApiTestMapper;
import io.zeroneqin.base.mapper.ext.ExtApiTestMapper;
...
import io.zeroneqin.commons.constants.ScheduleType;
...
public class APITestService {
    ...
    private ApiTest updateTest(SaveAPITestRequest request) {
        ...
        test.setGitlab(request.getGitlab());
        test.setGitbranch(request.getGitbranch());
