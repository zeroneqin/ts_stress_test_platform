...
import io.zeroneqin.api.jmeter.ScenarioResult;
import io.zeroneqin.api.jmeter.TestResult;
import io.zeroneqin.base.domain.*;
import io.zeroneqin.base.mapper.ApiScenarioMapper;
import io.zeroneqin.base.mapper.ApiScenarioReportDetailMapper;
import io.zeroneqin.base.mapper.ApiScenarioReportMapper;
import io.zeroneqin.base.mapper.TestPlanApiScenarioMapper;
import io.zeroneqin.base.mapper.ext.ExtApiScenarioReportMapper;
...
public class ApiScenarioReportService {
    ...
    public void deleteAPIReportBatch(DeleteAPIReportRequest reportRequest) {
        ...
        if (reportRequest.isSelectAllDate()) {
            ...
            selectRequest.setOrganizationId(SessionUtils.getCurrentOrganizationId());
