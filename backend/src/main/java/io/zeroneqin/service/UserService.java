...
import io.zeroneqin.base.mapper.ext.ExtUserMapper;
import io.zeroneqin.base.mapper.ext.ExtUserRoleMapper;
import io.zeroneqin.commons.constants.RoleConstants;
import io.zeroneqin.commons.constants.UserSource;
import io.zeroneqin.commons.constants.UserStatus;
import io.zeroneqin.commons.exception.MSException;
import io.zeroneqin.commons.user.SessionUser;
import io.zeroneqin.commons.utils.CodingUtil;
...
import io.zeroneqin.controller.request.member.AddMemberRequest;
import io.zeroneqin.controller.request.member.EditPassWordRequest;
import io.zeroneqin.controller.request.member.QueryMemberRequest;
import io.zeroneqin.controller.request.member.UserRequest;
import io.zeroneqin.controller.request.organization.AddOrgMemberRequest;
import io.zeroneqin.controller.request.organization.QueryOrgMemberRequest;
import io.zeroneqin.dto.UserDTO;
import io.zeroneqin.dto.UserRoleDTO;
...
import static io.zeroneqin.commons.constants.SessionConstants.ATTR_USER;
...
//                }
    ...
    public List<User> getUserListWithRequest(io.zeroneqin.controller.request.UserRequest request) {
