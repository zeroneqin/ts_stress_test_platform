...
import io.zeroneqin.service.WorkspaceService;
...
public class UserController {
    ...
    @RequiresRoles(RoleConstants.ADMIN)
    public Pager<List<User>> getUserList(@PathVariable int goPage, @PathVariable int pageSize, @RequestBody io.zeroneqin.controller.request.UserRequest request) {
    ...
    @RequiresRoles(value = {RoleConstants.ORG_ADMIN}, logical = Logical.OR)
